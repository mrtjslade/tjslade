export const projects = [
  ...
  },
  {
    ...
    services:
      "Website Overhaul, Subscription Platform, Stripe API, Vimeo API, Zoom API, Event & Ticket Management",
    description:
  ...
  },
  {
    ...
    services:
      "Website Redesign, Landing Page, Lead Capture, SEO, Reputation Management, Local Listings",
    description:
      "A redesigned strength training site engineered around lead capture and conversion, with prominent calls to action guiding visitors toward inquiries. Reinforced with technical SEO, reputation management, and local listings to drive consistent visibility and qualified traffic.",
    spaceDescription:
      "Strength training site redesigned around lead capture and conversion, with prominent calls to action guiding visitors toward inquiries. Reinforced with technical SEO, reputation management, and local listings to drive visibility across the sector and feed qualified traffic.",
  ...
  },
  {
    ...
    description:
      "A redesigned fitness business website with structured service breakdowns, program detail pages, and Google Workspace email routing for streamlined operations. Reinforced with SEO sanitation, managed hosting, and ongoing maintenance to support sustained program growth and visibility.",
    spaceDescription:
  ...
  },
  {
    ...
    description:
      "A clean and accessible chiropractic site built with patient clarity in mind, with a structured services breakdown and a clear path to scheduling appointments. Paired with Google Workspace integration, managed hosting, and a search structure tuned for local market reach.",
    spaceDescription:
      "Clean and accessible chiropractic dispatch built with patient clarity in mind, with a structured services breakdown and a clear path to scheduling appointments. Paired with Google Workspace integration, managed hosting, and a search structure tuned for local sector reach.",
    url: "https://tarrychiro.com",
  },
  {
    title: "Truman Chiropractic",
    services: "New Website, SEO, Hosting, Ongoing Maintenance",
    description:
      "A mobile first chiropractic site designed for patient clarity with simplified navigation, scannable service descriptions, and a clear path to booking. Supported by SEO sanitation, ongoing maintenance, and managed hosting to keep the site healthy as the practice grows.",
    spaceDescription:
      "Mobile first chiropractic dispatch designed for patient clarity with simplified navigation, scannable service descriptions, and a clear path to booking. Supported by SEO sanitation, ongoing maintenance, and managed hosting to keep the site healthy as the practice grows.",
